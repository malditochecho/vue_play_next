...
const { data, error, loading, fetchRecords, addRecord, deleteRecords } = useSupabase('games')
...
<template>
  <main class="min-h-screen w-full bg-gray-200 py-8">
    <div class="container mx-auto max-w-xl space-y-8">
      <!-- title -->
